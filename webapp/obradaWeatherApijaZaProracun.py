...
def zagadjenjedanas():
    ...
    #print(danas)
    podaciOvazduhu.append(trenutnozagadjenje['data']['forecast']['daily']['o3'][2]['avg'])
    podaciOvazduhu.append(trenutnozagadjenje['data']['forecast']['daily']['pm10'][2]['avg'])
    podaciOvazduhu.append(trenutnozagadjenje['data']['forecast']['daily']['pm25'][2]['avg'])
